    ...
    return (
        <>
            <div id="mitra" className={`${styles.paddingX} ${styles.flexStart}`}>
                <div className={`${styles.boxContent}`}>
                    <div className={`${styles.flexCenter} ${styles.descriptionPadding}`}>
                        <h2 className='font-bold max-w-[600px] text-[48px] text-center text-black leading-[58px]'>
            ...
            <div className={`${styles.flexCenter} flex-col overflow-hidden relative`}>
                ...
                <div className={`absolute w-full h-[585px] bg-atgblack sm:rounded-[150px] rounded-[50px] z-[0] px-[125px] pt-[200px] ${styles.flexCenter} bottom-0`}>
